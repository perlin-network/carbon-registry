...
import './addNewCompanyComponentUndp.scss';
  ...
  const CompanyDetailsForm = () => {
    const companyRoleClassName =
      companyRole === CompanyRole.CERTIFIER
        ...
        ? 'gov'
        : companyRole === CompanyRole.TRADER
        ? 'trader'
        : companyRole === CompanyRole.DEV_BANK
        ? 'dev-bank'
                        ...
                        { required: true, message: '' },
                        {
                          validator: async (rule, value) => {
                            if (
                              ...
                              throw new Error(`Mailing Address ${t('isRequired')}`);
                            }
                          },
                        },
                      ]}
                        ...
                        },
                        {
                          validator: async (rule, value) => {
                            if (
                              ...
                              throw new Error(`Name of the Minister ${t('isRequired')}`);
                            }
                          },
                        },
                      ]}
